'use strict';
/* STEP 10 + PWA CACHE HARDENING v1.5.0
 *
...
var FAMILYAPP_STATIC_CACHE_VERSION='familyapp-static-v5';
...
messaging.onBackgroundMessage(function(payload){
  ...
  var options={
    ...
    icon:'/api/brand-icon?variant=192&v=8',
    badge:'/api/brand-icon?variant=192&v=8',
