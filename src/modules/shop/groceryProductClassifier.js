'use strict';
// ============================================================
// GROCERY PRODUCT CLASSIFIER v1.3.0
...
// Unknown products intentionally carry no legacy emoji; the utility resolver
// supplies the canonical product/category fallback icon.
// ============================================================
(function(){
  var VERSION='1.3.0';
  ...
  function classify(name){
    ...
    if(!text)return result('Overig',null,'1 st',0,null);
    ...
    if(/\b(?:olie|saus|poeder|meel|rijst|pasta|granen|kruiden|noten)\b/.test(text))return result('Voorraad',null,'500 g',.35,'pantry-family');
    ...
    if(/\b(?:usb|bluetooth|wifi|hdmi|elektrisch|electronisch|elektronisch|computer|telefoon)\b/.test(text))return result('Elektronica',null,'1 st',.3,'electronics-family');
    ...
    return result('Overig',null,'1 st',0,null);
  }
