...
function stat(type,n,l){return '<div class="fs-stat '+type+'"><div class="fs-stat-ico">'+svgIcon(type)+'</div><div class="fs-stat-copy"><b>'+n+'</b><span>'+l+'</span></div><span class="fs-stat-arr">›</span></div>';}
