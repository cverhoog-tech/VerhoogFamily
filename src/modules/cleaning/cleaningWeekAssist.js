...
(function(){
  ...
  function hideSupply(id){id=text(id);if(!id)return;var hidden=hiddenSupplyIds();hidden[id]=true;saveHiddenSupplyIds(hidden);toast('Niet kopen · verborgen uit Weekvoorraad');queue();}
