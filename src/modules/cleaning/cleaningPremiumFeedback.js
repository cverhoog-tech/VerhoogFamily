...
(function(){
  ...
  ensureStyle('cleaning-v24-css','/src/styles/cleaning-v24.css?v=3');
  ensureStyle('cleaning-sheet-consistency-v1-css','/src/styles/cleaning-sheet-consistency-v1.css?v=1');
})();
...
window.CleaningV24Visual=Object.freeze({version:'2.4.1',presentationOnly:true,sheetConsistency:true});
export const CLEANING_PREMIUM_FEEDBACK_DISABLED=true;
export const CLEANING_V24_VISUAL_VERSION='2.4.1';
