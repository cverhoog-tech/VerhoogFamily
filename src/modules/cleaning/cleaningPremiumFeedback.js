...
// owners and writers; it only lazy-loads the official lightweight v2
// companions when Cleaning itself is opened by navigation.
window.CleaningPremiumFeedback=Object.freeze({version:'2.2.1-r1',disabledForCleaningV2:true});
