'use strict';
// Functional Cleaning V2.1-V2.5 companions. This loader is Cleaning-route only
...
import './cleaningDetailEscapeAvatarFixV1.js?v=1';
...
window.CleaningV23Companions=Object.freeze({version:'2.5.2',cleaningOnly:true});
export const CLEANING_COMPANION_LOADER_VERSION='2.5.2';
