...
// ============================================================
// CLEANING EXPERIENCE BOOTSTRAP v1.3.0
//
...
// v1.2.0 added the pure availability contract + availability experience.
// v1.3.0 adds a presentation-only Cleaning notification projector. It publishes
// through the existing NotificationStore and never owns Cleaning mutations.
//
...
//  10. cleaningNotificationProjector.js  - NotificationStore-only projection;
//                                           no Cleaning writer/action ownership.
//  11. cleaningTaskSupplyUi.js           - Task-detail Cleaning supplies.
//
// OWNERSHIP GUARDS
// -----------------
...
// - Notifications are deduped presentation events in NotificationStore; their
//   buttons do not create a second Cleaning mutation path.
...
export const CLEANING_EXPERIENCE_BOOTSTRAP_VERSION = '1.3.0';
