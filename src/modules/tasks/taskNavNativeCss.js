'use strict';
// ============================================================
// TASK NAV NATIVE CSS v0.329
// Tasks screen with internal scrolling and fully flush nav/content spacing.
// ============================================================

(function(){
  var STYLE_ID = 'task-nav-native-css-v0329';

  function inject(){
    ['task-nav-native-css-v0321','task-nav-native-css-v0322','task-nav-native-css-v0323','task-nav-native-css-v0324','task-nav-native-css-v0327','task-nav-native-css-v0328'].forEach(function(id){
    ...
    style.textContent = [
      ...
      '#screen-tasks #task-content .quest-add-wrap:first-child{margin-top:0!important;padding-top:0!important}',
