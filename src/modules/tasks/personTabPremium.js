...
(function(){
  ...
  function injectStyles(){
    ...
    var s=document.createElement('style');s.id='person-tab-premium-style-v4';s.textContent=[
      '.task-person-page{--ptp-bg:#080a14;--ptp-card:rgba(17,18,34,.78);--ptp-line:rgba(255,255,255,.075);--ptp-muted:rgba(244,246,255,.58);background:radial-gradient(90% 48% at 50% 0%,rgba(91,44,160,.24),transparent 70%),linear-gradient(180deg,#0b0d19,#070810);margin:0 -16px;padding:24px 16px 116px;min-height:100%;color:#f6f4ff;overflow-x:hidden}.task-person-page *{box-sizing:border-box}',
      '#screen-tasks:has(.task-person-page) .task-tabs{background:#0b0d19}#screen-tasks:has(.task-person-page) .ttab{color:rgba(244,246,255,.58)}#screen-tasks:has(.task-person-page) .ttab.active{background:linear-gradient(135deg,#6d28d9,#8b5cf6);color:#fff;box-shadow:0 6px 18px rgba(109,40,217,.22)}',
      ...
      '.ptp-members{display:flex;gap:14px;overflow-x:auto;overflow-y:visible;padding:8px 2px 12px;margin:-8px 0 10px;scrollbar-width:none}.ptp-members::-webkit-scrollbar{display:none}.ptp-member{flex:0 0 68px;border:0;background:none;color:inherit;padding:0;text-align:center;cursor:pointer}.ptp-avatar-wrap{position:relative;width:54px;height:54px;margin:0 auto 6px;overflow:visible}.ptp-avatar,.ptp-avatar-fallback{width:54px;height:54px;border-radius:50%;display:grid;place-items:center;object-fit:cover;border:2px solid rgba(255,255,255,.14);background:#272338;font-weight:900;font-size:14px;transition:.18s}.ptp-member.active .ptp-avatar,.ptp-member.active .ptp-avatar-fallback{border-color:var(--accent);box-shadow:0 0 0 2px #0b0d19,0 0 18px var(--glow)}.ptp-member-name{font-size:11px;font-weight:850;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;color:rgba(255,255,255,.68)}.ptp-member.active .ptp-member-name{color:#fff}.ptp-member-state{font-size:9px;color:rgba(255,255,255,.35);margin-top:1px}.ptp-presence-dot{position:absolute;right:-1px;bottom:1px;width:13px;height:13px;border-radius:50%;border:2.5px solid #0b0d19;background:#636977}.ptp-presence-dot.is-online{background:#22c55e;box-shadow:0 0 10px rgba(34,197,94,.55)}.ptp-presence-dot.is-recent{background:#84cc16}.ptp-presence-dot.is-today{background:#eab308}',
  ...
  window.renderTasksPersoon=function(el){
    ...
    if(!currentTarget)return;
    try{var screen=document.getElementById('screen-tasks');if(screen&&screen.scrollTop>0)screen.scrollTop=0;if(window.scrollY>0)window.scrollTo(0,0);}catch(e){}
