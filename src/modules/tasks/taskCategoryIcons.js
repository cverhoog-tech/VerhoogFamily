...
(function(){
  ...
  var PATHS={
    ...
    pantry:'<path d="M5 9h14l-1.5 9H6.5Z"/><path d="M8 9a4 4 0 0 1 8 0"/><path d="M9 13h6m-3-2v5"/><path d="M4 7.5 7 5m13 2.5L17 5" opacity=".6"/>',
  ...
  var ACCENTS={laundry:'#0284c7',cleaning:'#7c3aed',kitchen:'#0d9488',groceries:'#059669',pantry:'#d97706',admin:'#6366f1',family:'#db2777',garden:'#65a30d',travel:'#2563eb',dropoff:'#c2410c',pickup:'#0891b2',quest:'#7c3aed'};
