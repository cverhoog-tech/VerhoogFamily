...
(function(){
  ...
  function injectStyles(){
    ...
    s.textContent =
      ...
      '.tdp-hero:after{content:"";position:absolute;inset:0;pointer-events:none;'+
        'background:linear-gradient(180deg,transparent 0%,transparent 36%,var(--tdp-bg) 100%),radial-gradient(130% 85% at 50% 0%,rgba(255,255,255,.08),rgba(255,255,255,0) 60%),linear-gradient(180deg,rgba(0,0,0,.16),rgba(0,0,0,.08) 40%,rgba(0,0,0,.34));'+
        'background:linear-gradient(180deg,transparent 0%,color-mix(in srgb,var(--tdp-bg) 55%,transparent) 68%,var(--tdp-bg) 100%),radial-gradient(130% 85% at 50% 0%,rgba(255,255,255,.08),rgba(255,255,255,0) 60%),linear-gradient(180deg,rgba(0,0,0,.16),rgba(0,0,0,.08) 40%,rgba(0,0,0,.34))'+
      '}'+
