'use strict';
// ============================================================
// LEGACY AUTHORITY RETIREMENT v1.0.0
...
(function(){
  ...
  function retireRootRead(){
    ...
    try{if(window.HouseholdSessionHardening&&HouseholdSessionHardening.stopFirebaseSync)HouseholdSessionHardening.stopFirebaseSync();}catch(e){}
