...
,
    ...
    ['skills.ability.notOwned','Je hebt deze ability niet (of niet genoeg)','You do not have this ability (or enough charges)','Bu yeteneğe sahip değilsin (veya yeterli kullanım hakkın yok)','Nie masz tej umiejętności (lub masz za mało użyć)','Nu ai această abilitate (sau suficiente utilizări)'],
    ['skills.ability.postponed','“{{title}}” {{count}} dag(en) uitgesteld!','“{{title}}” postponed by {{count}} day(s)!','“{{title}}” {{count}} gün ertelendi!','„{{title}}” odroczono o {{count}} dni!','„{{title}}” amânată cu {{count}} zile!'],
    ['skills.ability.postponedActivity','{{name}} stelde “{{title}}” uit ({{ability}})','{{name}} postponed “{{title}}” ({{ability}})','{{name}}, “{{title}}” görevini erteledi ({{ability}})','{{name}} odroczył(a) „{{title}}” ({{ability}})','{{name}} a amânat „{{title}}” ({{ability}})'],
    ['skills.ability.freeTradeActive','🤝 Gratis Ruil actief! Volgende taakruil zonder tegenprestatie.','🤝 Free Swap active! Your next task swap needs nothing in return.','🤝 Ücretsiz Takas aktif! Sonraki görev takasında karşılık gerekmez.','🤝 Darmowa zamiana aktywna! Następna zamiana zadania bez niczego w zamian.','🤝 Schimb gratuit activ! Următorul schimb de sarcini nu cere nimic în schimb.'],
    ['skills.ability.reassigned','🔄 Taak “{{title}}” overgedragen aan {{name}}!','🔄 Task “{{title}}” reassigned to {{name}}!','🔄 “{{title}}” görevi {{name}} kişisine devredildi!','🔄 Zadanie „{{title}}” przekazano: {{name}}!','🔄 Sarcina „{{title}}” a fost transferată către {{name}}!'],
    ['skills.ability.reassignedActivity','{{name}} droeg “{{title}}” over aan {{target}}','{{name}} reassigned “{{title}}” to {{target}}','{{name}}, “{{title}}” görevini {{target}} kişisine devretti','{{name}} przekazał(a) „{{title}}” osobie {{target}}','{{name}} a transferat „{{title}}” către {{target}}'],
    ['skills.ability.part1','deel 1','part 1','bölüm 1','część 1','partea 1'],
    ['skills.ability.part2','deel 2','part 2','bölüm 2','część 2','partea 2'],
    ['skills.ability.splitDone','✂️ Taak gesplitst in 2 kleinere taken!','✂️ Task split into 2 smaller tasks!','✂️ Görev 2 küçük göreve bölündü!','✂️ Zadanie podzielono na 2 mniejsze zadania!','✂️ Sarcina a fost împărțită în 2 sarcini mai mici!'],
    ['skills.ability.shielded','🛡️ Taak “{{title}}” heeft een schild!','🛡️ Task “{{title}}” is shielded!','🛡️ “{{title}}” görevi kalkanla korundu!','🛡️ Zadanie „{{title}}” ma tarczę!','🛡️ Sarcina „{{title}}” are un scut!'],
    ['skills.ability.frozen','🧊 Taak “{{title}}” bevroren — verborgen!','🧊 Task “{{title}}” frozen — hidden!','🧊 “{{title}}” görevi donduruldu — gizlendi!','🧊 Zadanie „{{title}}” zamrożone — ukryte!','🧊 Sarcina „{{title}}” a fost înghețată — ascunsă!'],
    ['skills.ability.doubleActive','⚡ Dubbel-XP actief voor je volgende taak!','⚡ Double XP active for your next task!','⚡ Sonraki görevin için Çift XP aktif!','⚡ Podwójne XP aktywne dla następnego zadania!','⚡ XP dublu activ pentru următoarea sarcină!'],
    ['skills.ability.tripleActive','🔥 Triple-XP actief! Ga snel een taak doen!','🔥 Triple XP active! Go complete a task!','🔥 Üçlü XP aktif! Hemen bir görev tamamla!','🔥 Potrójne XP aktywne! Szybko ukończ zadanie!','🔥 XP triplu activ! Finalizează rapid o sarcină!'],
    ['skills.ability.xpBombActive','💣 XP-bom actief! Alle taken vandaag +50% XP','💣 XP Bomb active! All tasks today give +50% XP','💣 XP Bombası aktif! Bugünkü tüm görevler +%50 XP','💣 Bomba XP aktywna! Wszystkie dzisiejsze zadania dają +50% XP','💣 Bombă XP activă! Toate sarcinile de azi oferă +50% XP'],
    ['skills.ability.xpBombActivity','{{name}} activeerde XP-bom!','{{name}} activated the XP Bomb!','{{name}} XP Bombasını etkinleştirdi!','{{name}} aktywował(a) Bombę XP!','{{name}} a activat Bomba XP!'],
    ['skills.ability.skillBoostActive','🌱 Skill-turbo actief! Volgende skill-taak = 3x XP','🌱 Skill Turbo active! Next skill task = 3x XP','🌱 Beceri Turbo aktif! Sonraki beceri görevi = 3x XP','🌱 Turbo umiejętności aktywne! Następne zadanie umiejętności = 3x XP','🌱 Turbo abilitate activ! Următoarea sarcină de abilitate = 3x XP'],
    ['skills.ability.skillBoostActivity','{{name}} activeerde Skill-turbo!','{{name}} activated Skill Turbo!','{{name}} Beceri Turboyu etkinleştirdi!','{{name}} aktywował(a) Turbo umiejętności!','{{name}} a activat Turbo abilitate!'],
    ['skills.ability.pardoned','🎁 Taak “{{title}}” vergeven en vergeten!','🎁 Task “{{title}}” pardoned and forgotten!','🎁 “{{title}}” görevi affedildi ve unutuldu!','🎁 Zadanie „{{title}}” wybaczone i zapomniane!','🎁 Sarcina „{{title}}” iertată și uitată!'],
    ['skills.ability.amnesiaDone','🧹 {{count}} taken weggepoetst — poof!','🧹 {{count}} tasks wiped away — poof!','🧹 {{count}} görev silindi — puf!','🧹 Usunięto {{count}} zadań — puf!','🧹 {{count}} sarcini au dispărut — puf!'],
    ['skills.ability.spyResult','🕵️ {{name}} heeft {{count}} bevroren taken. Nu weet je het!','🕵️ {{name}} has {{count}} frozen tasks. Now you know!','🕵️ {{name}} kullanıcısının {{count}} dondurulmuş görevi var. Artık biliyorsun!','🕵️ {{name}} ma {{count}} zamrożonych zadań. Teraz już wiesz!','🕵️ {{name}} are {{count}} sarcini înghețate. Acum știi!'],
    ['skills.ability.copiedSuffix','gekopieerd','copied','kopyalandı','skopiowano','copiată'],
    ['skills.ability.copied','🐱 Gekopieerd: “{{title}}” staat op jouw naam!','🐱 Copied: “{{title}}” is now assigned to you!','🐱 Kopyalandı: “{{title}}” artık sana atanmış!','🐱 Skopiowano: „{{title}}” jest teraz przypisane do Ciebie!','🐱 Copiat: „{{title}}” este acum atribuită ție!'],
    ['skills.ability.noCompletedPartner','Geen voltooide taken van {{name}} gevonden','No completed tasks found for {{name}}','{{name}} için tamamlanmış görev bulunamadı','Nie znaleziono ukończonych zadań dla {{name}}','Nu s-au găsit sarcini finalizate pentru {{name}}'],
    ['skills.ability.streakSaved','🔥 Streak-redder opgeslagen! Wordt gebruikt als je een week mist.','🔥 Streak Saver saved! It will be used if you miss a week.','🔥 Seri Kurtarıcı kaydedildi! Bir haftayı kaçırırsan kullanılacak.','🔥 Ratownik serii zapisany! Zostanie użyty, jeśli opuścisz tydzień.','🔥 Salvator de serie salvat! Va fi folosit dacă ratezi o săptămână.'],
    ['skills.ability.streakActivity','{{name}} heeft een Streak-redder!','{{name}} has a Streak Saver!','{{name}} bir Seri Kurtarıcıya sahip!','{{name}} ma Ratownika serii!','{{name}} are un Salvator de serie!'],
    ['skills.ability.autoDone','✨ Taak “{{title}}” auto-afgevinkt!','✨ Task “{{title}}” auto-completed!','✨ “{{title}}” görevi otomatik tamamlandı!','✨ Zadanie „{{title}}” automatycznie ukończone!','✨ Sarcina „{{title}}” finalizată automat!'],
    ['skills.ability.budgetResult','👁️ Budget-röntgen: {{name}} gaf € {{amount}} uit deze maand','👁️ Budget X-Ray: {{name}} spent € {{amount}} this month','👁️ Bütçe Röntgeni: {{name}} bu ay € {{amount}} harcadı','👁️ Rentgen budżetu: {{name}} wydał(a) w tym miesiącu € {{amount}}','👁️ Radiografie buget: {{name}} a cheltuit € {{amount}} luna aceasta'],
    ['skills.ability.savingsActive','💎 Spaar-multiplier actief! Volgende storting telt dubbel.','💎 Savings Multiplier active! Your next deposit counts double.','💎 Tasarruf Çarpanı aktif! Sonraki yatırma iki kat sayılır.','💎 Mnożnik oszczędności aktywny! Następna wpłata liczy się podwójnie.','💎 Multiplicator economii activ! Următoarea depunere contează dublu.'],
    ['skills.ability.savingsActivity','{{name}} activeerde Spaar-multiplier!','{{name}} activated the Savings Multiplier!','{{name}} Tasarruf Çarpanını etkinleştirdi!','{{name}} aktywował(a) Mnożnik oszczędności!','{{name}} a activat Multiplicator economii!'],
    ['skills.ability.useButton','{{icon}} Gebruik ability','{{icon}} Use ability','{{icon}} Yeteneği kullan','{{icon}} Użyj umiejętności','{{icon}} Folosește abilitatea'],
    ['skills.weekly.extraProgress','⭐ Extra taak! +1 voortgang op je quest','⭐ Extra task! +1 quest progress','⭐ Ekstra görev! Quest ilerlemesi +1','⭐ Dodatkowe zadanie! +1 postępu questa','⭐ Sarcină extra! +1 progres la quest'],
...
,
    ...
    ['common.confirm','Bevestigen','Confirm','Onayla','Potwierdź','Confirmă'],
    ['common.areYouSure','Weet je het zeker?','Are you sure?','Emin misiniz?','Czy na pewno?','Ești sigur?'],
    ['common.optional','optioneel','optional','isteğe bağlı','opcjonalnie','opțional'],
...
,
    ...
    ['party.service.invalidInviteResponse','Ongeldige uitnodigingsreactie','Invalid invitation response','Geçersiz davet yanıtı','Nieprawidłowa odpowiedź na zaproszenie','Răspuns invalid la invitație'],
    ['party.service.inviteMissing','Uitnodiging ontbreekt','Invitation is missing','Davet eksik','Brakuje zaproszenia','Lipsește invitația'],
    ['party.service.inviteInactive','Deze uitnodiging is niet meer actief','This invitation is no longer active','Bu davet artık aktif değil','To zaproszenie nie jest już aktywne','Această invitație nu mai este activă'],
    ['party.service.wrongInviteRecipient','Deze uitnodiging is voor een ander gezinslid','This invitation is for another family member','Bu davet başka bir aile üyesi için','To zaproszenie jest dla innego członka rodziny','Această invitație este pentru alt membru al familiei'],
    ['party.service.inviteHandled','Deze uitnodiging is al afgehandeld','This invitation has already been handled','Bu davet zaten işlendi','To zaproszenie zostało już obsłużone','Această invitație a fost deja procesată'],
    ['party.service.questMissing','Party Quest ontbreekt','Party Quest is missing','Party Quest eksik','Brakuje Party Quest','Lipsește Party Quest'],
    ['party.service.questInactive','Deze Party Quest is niet meer actief','This Party Quest is no longer active','Bu Party Quest artık aktif değil','Ten Party Quest nie jest już aktywny','Acest Party Quest nu mai este activ'],
    ['party.service.creatorCannotLeave','De maker kan de Party Quest niet verlaten; beëindig hem in plaats daarvan','The creator cannot leave the Party Quest; end it instead','Oluşturan kişi Party Quest’ten ayrılamaz; bunun yerine görevi bitir','Twórca nie może opuścić Party Quest; zamiast tego zakończ go','Creatorul nu poate părăsi Party Quest; încheie-l în schimb'],
    ['party.service.notParticipant','Je neemt niet deel aan deze Party Quest','You are not participating in this Party Quest','Bu Party Quest’e katılmıyorsun','Nie uczestniczysz w tym Party Quest','Nu participi la acest Party Quest'],
    ['party.service.participantInactive','Je bent geen actieve deelnemer meer','You are no longer an active participant','Artık aktif bir katılımcı değilsin','Nie jesteś już aktywnym uczestnikiem','Nu mai ești participant activ'],
    ['party.service.chooseHelpTarget','Kies iemand om hulp te vragen','Choose someone to ask for help','Yardım isteyeceğin birini seç','Wybierz osobę, którą poprosisz o pomoc','Alege pe cineva căruia să-i ceri ajutor'],
    ['party.service.helpRequiresActive','Je kunt alleen vanuit een actieve Party Quest hulp vragen','You can only ask for help from an active Party Quest','Yalnızca aktif bir Party Quest’ten yardım isteyebilirsin','Możesz prosić o pomoc tylko z aktywnego Party Quest','Poți cere ajutor doar dintr-un Party Quest activ'],
    ['party.service.creatorHelpOnly','Alleen de maker kan extra hulp vragen','Only the creator can ask for extra help','Yalnızca oluşturucu ek yardım isteyebilir','Tylko twórca może poprosić o dodatkową pomoc','Doar creatorul poate cere ajutor suplimentar'],
    ['party.service.taskNotOpen','De gekoppelde taak is niet meer open','The linked task is no longer open','Bağlı görev artık açık değil','Powiązane zadanie nie jest już otwarte','Sarcina asociată nu mai este deschisă'],
    ['party.service.helpAlreadyOpen','Er staat al een hulpvraag open voor deze Party Quest','A help request is already open for this Party Quest','Bu Party Quest için zaten açık bir yardım isteği var','Dla tego Party Quest jest już otwarta prośba o pomoc','Există deja o cerere de ajutor deschisă pentru acest Party Quest'],
    ['party.service.memberUnavailable','Dit gezinslid doet al mee, is toegewezen of is niet beschikbaar','This family member is already participating, assigned, or unavailable','Bu aile üyesi zaten katılıyor, atanmış veya uygun değil','Ten członek rodziny już uczestniczy, jest przypisany lub niedostępny','Acest membru al familiei participă deja, este atribuit sau indisponibil'],
    ['party.service.noEligibleMembers','Er is nu niemand extra beschikbaar om hulp te vragen','No one else is available to ask for help right now','Şu anda yardım isteyebileceğin başka kimse yok','Nie ma teraz nikogo dodatkowego, kogo można poprosić o pomoc','Nu mai este nimeni disponibil pentru a cere ajutor acum'],
    ['party.service.invalidHelpResponse','Ongeldige hulp-reactie','Invalid help response','Geçersiz yardım yanıtı','Nieprawidłowa odpowiedź na prośbę o pomoc','Răspuns invalid la cererea de ajutor'],
    ['party.service.helpMissing','Hulpvraag ontbreekt','Help request is missing','Yardım isteği eksik','Brakuje prośby o pomoc','Lipsește cererea de ajutor'],
    ['party.service.helpNotOpen','Deze hulpvraag is niet meer open','This help request is no longer open','Bu yardım isteği artık açık değil','Ta prośba o pomoc nie jest już otwarta','Această cerere de ajutor nu mai este deschisă'],
    ['party.service.requesterCannotRespond','Je kunt niet op je eigen hulpvraag reageren','You cannot respond to your own help request','Kendi yardım isteğine yanıt veremezsin','Nie możesz odpowiadać na własną prośbę o pomoc','Nu poți răspunde propriei cereri de ajutor'],
    ['party.service.wrongHelpRecipient','Deze hulpvraag is voor een ander gezinslid','This help request is for another family member','Bu yardım isteği başka bir aile üyesi için','Ta prośba o pomoc jest dla innego członka rodziny','Această cerere de ajutor este pentru alt membru al familiei'],
    ['party.service.helpHandled','Je hebt deze hulpvraag al afgehandeld','You have already handled this help request','Bu yardım isteğini zaten işledin','Ta prośba o pomoc została już przez ciebie obsłużona','Ai procesat deja această cerere de ajutor'],
    ['party.service.helpIneligible','Je kunt niet meer aan deze hulpvraag deelnemen','You can no longer participate in this help request','Bu yardım isteğine artık katılamazsın','Nie możesz już uczestniczyć w tej prośbie o pomoc','Nu mai poți participa la această cerere de ajutor'],
    ['party.service.creatorRetractOnly','Alleen de maker kan deze hulpvraag intrekken','Only the creator can withdraw this help request','Yalnızca oluşturucu bu yardım isteğini geri çekebilir','Tylko twórca może wycofać tę prośbę o pomoc','Doar creatorul poate retrage această cerere de ajutor'],
    ['party.service.creatorRevokeOnly','Alleen de maker kan deze uitnodiging intrekken','Only the creator can revoke this invitation','Yalnızca oluşturucu bu daveti geri çekebilir','Tylko twórca może wycofać to zaproszenie','Doar creatorul poate retrage această invitație'],
    ['party.service.inviteCannotRevoke','Deze uitnodiging kan niet meer worden ingetrokken','This invitation can no longer be revoked','Bu davet artık geri çekilemez','Tego zaproszenia nie można już wycofać','Această invitație nu mai poate fi retrasă'],
    ['party.service.creatorEndOnly','Alleen de maker kan deze Party Quest beëindigen','Only the creator can end this Party Quest','Yalnızca oluşturucu bu Party Quest’i bitirebilir','Tylko twórca może zakończyć ten Party Quest','Doar creatorul poate încheia acest Party Quest'],
    ['party.service.completedCannotCancel','Een voltooide Party Quest kan niet worden geannuleerd','A completed Party Quest cannot be cancelled','Tamamlanmış bir Party Quest iptal edilemez','Ukończonego Party Quest nie można anulować','Un Party Quest finalizat nu poate fi anulat'],
    ['party.service.alreadyEnded','Deze Party Quest is al beëindigd','This Party Quest has already ended','Bu Party Quest zaten sona erdi','Ten Party Quest został już zakończony','Acest Party Quest s-a încheiat deja'],
    ['party.service.onlyActiveComplete','Alleen een actieve Party Quest kan worden voltooid','Only an active Party Quest can be completed','Yalnızca aktif bir Party Quest tamamlanabilir','Można ukończyć tylko aktywny Party Quest','Doar un Party Quest activ poate fi finalizat'],
    ['party.service.waitTaskConfirmed','Wacht tot de voltooide taak door het gezin is bevestigd','Wait until the completed task is confirmed by the family','Tamamlanan görevin aile tarafından onaylanmasını bekle','Poczekaj, aż ukończone zadanie zostanie potwierdzone przez rodzinę','Așteaptă până când sarcina finalizată este confirmată de familie'],
    ['party.service.taskNotCompleted','De gekoppelde taak is nog niet voltooid','The linked task has not been completed yet','Bağlı görev henüz tamamlanmadı','Powiązane zadanie nie zostało jeszcze ukończone','Sarcina asociată nu este încă finalizată'],
    ['party.service.needsParticipant','Een Party Quest heeft minstens een actieve medespeler nodig','A Party Quest needs at least one active teammate','Bir Party Quest için en az bir aktif takım arkadaşı gerekir','Party Quest wymaga co najmniej jednego aktywnego uczestnika','Un Party Quest are nevoie de cel puțin un coechipier activ'],
    ['party.service.rewardSettlementMissing','Reward settlement ontbreekt','Reward settlement is missing','Ödül uzlaşması eksik','Brakuje rozliczenia nagrody','Lipsește înregistrarea recompensei'],
    ['party.service.notCompleted','Deze Party Quest is nog niet voltooid','This Party Quest has not been completed yet','Bu Party Quest henüz tamamlanmadı','Ten Party Quest nie został jeszcze ukończony','Acest Party Quest nu este încă finalizat'],
    ['party.service.rewardMismatch','Reward occurrence komt niet overeen','Reward occurrence does not match','Ödül olayı eşleşmiyor','Zdarzenie nagrody nie pasuje','Evenimentul recompensei nu corespunde'],
    ['party.service.rewardNotForUser','Er staat geen Party Quest-beloning voor deze gebruiker klaar','There is no Party Quest reward ready for this user','Bu kullanıcı için hazır Party Quest ödülü yok','Dla tego użytkownika nie ma gotowej nagrody Party Quest','Nu există o recompensă Party Quest pregătită pentru acest utilizator'],
    ['party.service.rewardNotConfirmed','De XP-beloning is nog niet canoniek bevestigd','The XP reward has not been canonically confirmed yet','XP ödülü henüz doğrulanmadı','Nagroda XP nie została jeszcze kanonicznie potwierdzona','Recompensa XP nu a fost încă confirmată canonic'],
    ['party.service.staleContext','De Party Quest is veranderd. Open hem opnieuw en probeer het nog eens.','The Party Quest changed. Reopen it and try again.','Party Quest değişti. Yeniden açıp tekrar dene.','Party Quest się zmienił. Otwórz go ponownie i spróbuj jeszcze raz.','Party Quest s-a schimbat. Redeschide-l și încearcă din nou.'],

    ['tasks.recurringDayReward','Vaste taak dag','Recurring task day','Tekrarlanan görev günü','Dzień zadania cyklicznego','Zi de sarcină recurentă'],
    ['tasks.readiness.session','Canonical sessie is nog niet beschikbaar','Canonical session is not available yet','Kanonik oturum henüz kullanılamıyor','Sesja kanoniczna nie jest jeszcze dostępna','Sesiunea canonică nu este încă disponibilă'],
...
,
    ...
    ['tasks.create.noteLabel','Notitie / omschrijving','Note / description','Not / açıklama','Notatka / opis','Notiță / descriere'],
    ['tasks.create.notePlaceholder','Bijv. witte was apart, gebruik fijnwasprogramma…','E.g. separate whites, use the delicate cycle…','Örn. beyazları ayrı yıka, hassas programı kullan…','Np. białe pranie osobno, użyj programu delikatnego…','De ex. spală albele separat, folosește programul delicat…'],
    ['tasks.create.chooseMember','Kies minimaal één gezinslid','Choose at least one family member','En az bir aile üyesi seç','Wybierz co najmniej jednego członka rodziny','Alege cel puțin un membru al familiei'],
    ['tasks.activityCreated','{{name}} maakte taak “{{title}}” aan','{{name}} created task “{{title}}”','{{name}}, “{{title}}” görevini oluşturdu','{{name}} utworzył(a) zadanie „{{title}}”','{{name}} a creat sarcina „{{title}}”'],
