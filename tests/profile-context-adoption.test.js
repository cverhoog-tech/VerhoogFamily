...
assert.ok(loader.includes('src/modules/profile/profileContextService.js?v=1'));assert.ok(/src\/modules\/profile\/profileRuntimeContextBridge\.js\?v=\d+/.test(loader));assert.ok(loader.includes('src/modules/tasks/personDashboardService.js?v=3'));
