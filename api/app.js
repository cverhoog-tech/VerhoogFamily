...
module.exports = async function handler(req, res) {
  try {
    ...
    html = html.replace(
      ...
      + '  <script src="src/core/authSessionBootstrap.js?v=4"></script>\n'
      + '  <script src="src/core/authStartupReadinessGate.js?v=1"></script>\n'
    ...
    // Guest/offline-without-account mode is retired. Normal authenticated
