...
module.exports = async function handler(req, res) {
  try {
    ...
    html = html.replace('<script src="src/modules/shop/shop.js"></script>','<script src="src/modules/shop/shop.js?v=2"></script>');
    html = html.replace('<script src="src/modules/meals/meals.js"></script>','<script src="src/modules/meals/meals.js?v=2"></script>');
    html = html.replace('<script src="src/modules/recipes/recipePremiumCardBridge.js"></script>','<script src="src/modules/recipes/recipePremiumCardBridge.js?v=2"></script>');
