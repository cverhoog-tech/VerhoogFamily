...
module.exports = async function handler(req, res) {
  try {
    ...
    html = html.replace('<script src="src/modules/tasks/personTabPremium.js"></script>','<script src="src/core/profileMedia.js?v=1"></script>\n  <script src="src/modules/tasks/personDashboardService.js?v=4"></script>\n  <script src="src/modules/tasks/personTabV2.js?v=2"></script>');
    html = html.replace('<link rel="stylesheet" href="src/styles/quest.css">','<link rel="stylesheet" href="src/styles/quest.css">\n  <link rel="stylesheet" href="src/styles/taskShellThemes.css?v=1">\n  <link rel="stylesheet" href="src/styles/personTabV2.css?v=2">\n  <link rel="stylesheet" href="src/styles/taskDetailControlFix.css?v=1">');
