...
assert.ok(actionsIndex>serviceIndex&&projectorIndex>serviceIndex,'frozen NotificationActions and STEP 11.6 notification projector must load after PartyQuestService');
