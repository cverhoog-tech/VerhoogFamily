...
assert.ok(templates.includes("import './cleaningRecurringPlanContract.js?v=2';"));
assert.ok(templates.includes("import './cleaningRoutineExperience.js?v=1';"));
assert.ok(templates.includes("import './cleaningActivePlanReconciler.js?v=1';"));
assert.ok(templates.includes("import './cleaningRollingPlannerService.js?v=1';"));
assert.ok(templates.includes("import './cleaningProjectionService.js?v=3';"));
assert.ok(templates.indexOf('cleaningRecurringPlanContract.js?v=2') < templates.indexOf('cleaningRoutineExperience.js?v=1'));
assert.ok(templates.indexOf('cleaningRoutineExperience.js?v=1') < templates.indexOf('cleaningActivePlanReconciler.js?v=1'));
assert.ok(templates.indexOf('cleaningActivePlanReconciler.js?v=1') < templates.indexOf('cleaningRollingPlannerService.js?v=1'));
assert.ok(templates.indexOf('cleaningRollingPlannerService.js?v=1') < templates.indexOf('cleaningProjectionService.js?v=3'));
assert.ok(recurring.includes("version:'0.7.0'"),'recurring contract must replace weekly planner generation');
assert.ok(experience.includes("var VERSION='0.2.0'"));
assert.ok(rolling.includes("var VERSION='0.1.0'"));
