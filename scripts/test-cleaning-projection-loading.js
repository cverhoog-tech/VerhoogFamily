...
assert.ok(templates.includes("import './cleaningRollingPlannerService.js?v=2';"));
...
assert.ok(templates.indexOf('cleaningRoutineExperience.js?v=2') < templates.indexOf('cleaningActivePlanReconciler.js?v=1'));
assert.ok(templates.indexOf('cleaningActivePlanReconciler.js?v=1') < templates.indexOf('cleaningRollingPlannerService.js?v=2'));
assert.ok(templates.indexOf('cleaningRollingPlannerService.js?v=2') < templates.indexOf('cleaningProjectionService.js?v=3'));
