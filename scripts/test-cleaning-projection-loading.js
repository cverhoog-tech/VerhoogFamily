...
assert.ok(templates.includes("import './cleaningSupplyExperience.js?v=1';"));
...
assert.ok(templates.indexOf('cleaningRoomListControlsV2.js?v=1') < templates.indexOf('cleaningSupplyExperience.js?v=1'));
assert.ok(templates.indexOf('cleaningSupplyExperience.js?v=1') < templates.indexOf('cleaningActivePlanReconciler.js?v=2'));
...
console.log('cleaning supplies + pure execution writer + UI ownership order: ok');
