...
ok(sw.includes("FAMILYAPP_STATIC_CACHE_VERSION='familyapp-static-v4'"),'versioned FamilyApp static cache exists at the current brand-v7 generation');
...
ok(sw.includes("icon:'/src/assets/brand/v6/familyapp-icon-192.png?v=7'")&&sw.includes("badge:'/src/assets/brand/v6/familyapp-icon-192.png?v=7'"),'push surfaces use canonical FamilyApp brand-v7 icon generation');
