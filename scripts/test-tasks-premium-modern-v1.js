...
assert(shell.includes('/src/styles/tasksV3Polish.css?v=1'),'Tasks V3 compact polish must be served');
...
console.log('Tasks modern v1 retirement / V3 compact activation contract: PASS');