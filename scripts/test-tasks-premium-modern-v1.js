...
// Modern v1 remains in history, but it must no longer participate in the served UI.
...
assert(shell.includes('/src/styles/tasksV3.css?v=1'),'Tasks V3 stylesheet must be served');
assert(shell.includes('/src/modules/tasks/v3/taskPresentationModelV3.js?v=1'),'Tasks V3 model must be served');
assert(shell.includes('/src/modules/tasks/v3/taskOverviewV3.js?v=1'),'Tasks V3 overview must be served');
assert(shell.includes('/src/modules/tasks/v3/taskDetailV3.js?v=1'),'Tasks V3 detail must be served');
